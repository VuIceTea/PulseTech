...
export default function ProfilePage() {
  ...
  const menuItems = [
    { id: 'home', icon: 'https://img.icons8.com/fluency/48/home.png', label: 'Trang chủ PulseMember' },
...
function TabHome({ user }: { user: any }) {
  return (
    <div className="space-y-6">
      <h2 className="text-xl font-bold text-brand-black uppercase tracking-wide">Trang chủ PulseMember</h2>
